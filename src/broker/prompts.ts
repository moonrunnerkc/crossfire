...
export function buildFixPrompt(input: FixPromptInput): string {
  ...
  return [
    ...
    "- If a module you change has a sibling test file, extend it with a case for",
    "  the shape you are closing, in the spellings that shape can be written in.",
    "  The repro proves this one input is dead; the test is what keeps it dead.",
